...
function FormDeletarAero({aberto,fechado,nomeAero}:props) {
    ...
    return (
        <div className="max-w-xl mx-auto m-5  p-8 bg-white border border-gray-200 rounded-3xl shadow-sm fixed inset-70 justify-center flex items-center z-50 top-70">
           <div className='flex justify-between'>  <h2 className="text-2xl font-bold text-[#123354] mb-6 absolute top-8 left-12 ">Deletar Aeronave</h2> <button 
                    onClick={fechado}
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                ...
                <div className="flex flex-col md:col-span-2 lg:col-span-1">
                    <label className="text-sm font-medium text-gray-700 mb-1">ID da Aeronave</label>
                    <input
                        type="text"
                        value={nomeAero}
                        className="px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 outline-none transition-all"
                    />
                </div>
...
export default FormDeletarAero