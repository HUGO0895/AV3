...
function FormCadastroAero({aberto,fechado}:props){
     ...
     return (
       <div className="max-w-2xl mx-auto m-5 p-8 bg-white border border-gray-200 rounded-3xl shadow-sm fixed inset-40 justify-center flex items-center z-50">
        <div className='flex justify-between'>  <h2 className="text-2xl font-bold text-[#123354] mb-6 absolute top-8 left-12 ">Cadastrar Aeronave</h2> <button 
                    onClick={fechado}
        ...
        <div className="flex flex-col">
         ...
         <div className="flex flex-col">
          <label className="text-sm font-medium text-gray-700 mb-1">Tipo</label>
           <select name="Tipo" id="" className='px-4 py-[11px] border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#123354] outline-none'>
            <option value="COMERCIAL">Cormercial</option>
